...
\kotae{
根号内$\geqq0$（分母は$>0$）の条件を解く．

(1) $x-2\geqq0$ より $x\geqq2$

(2) $x+1>0$ より $x>-1$

(3) $-x^{2}+x+6\geqq0$ → $x^{2}-x-6\leqq0$ → $(x+2)(x-3)\leqq0$ より $-2\leqq x\leqq 3$
}
...
\kotae{
(1) $x$軸対称：$y\to-y$ → $-y=x^{3}+3x^{2}$ → $y=-x^{3}-3x^{2}$

(2) $y$軸対称：$x\to-x$ → $y=(-x)^{3}+3(-x)^{2}=-x^{3}+3x^{2}$

(3) 原点対称：$x\to-x,\;y\to-y$ → $-y=-x^{3}+3x^{2}$ → $y=x^{3}-3x^{2}$
}
...
(1) $y=\dfrac{1}{x-2}$ → $x-2=\dfrac{1}{y}$ → $x=\dfrac{1}{y}+2$

入替え：$y=\dfrac{1}{x}+2$\quad 定義域$x\neq0$，値域$y\neq2$

(2) $y=x^{2}-3\;(x\geqq0)$ → $x^{2}=y+3$ → $x=\sqrt{y+3}$（$x\geqq0$）

入替え：$y=\sqrt{x+3}$\quad 定義域$x\geqq-3$，値域$y\geqq0$

(3) $y=-\sqrt{x}$ → $\sqrt{x}=-y$ → $x=y^{2}$（$y\leqq0$）

入替え：$y=x^{2}\;(x\leqq0)$\quad 定義域$x\leqq0$，値域$y\geqq0$

(4) $y=\sqrt{2-x}-1$ → $y+1=\sqrt{2-x}$ → $(y+1)^{2}=2-x$ → $x=-(y+1)^{2}+2$（$y\geqq-1$）

入替え：$y=-x^{2}-2x+1\;(x\geqq-1)$\quad 定義域$x\geqq-1$，値域$y\leqq2$
}
