...
\kotae{
$y=f(x)$ の $x$ と $y$ を入れ替えて $x=f(y)$ とし，$y$ について解く．

(1) $y=-ax+b\;(a\neq0)$

$x=-ay+b \Rightarrow ay=b-x$

$\therefore y=\dfrac{b-x}{a}\;\left(=-\dfrac{x}{a}+\dfrac{b}{a}\right)$

(2) $y=1-x^{2}\;(x\leqq0)$

$x=1-y^{2}\;(y\leqq0)$．$y^{2}=1-x$，$y\leqq0$ なので $y=-\sqrt{1-x}$．

$\therefore y=-\sqrt{1-x}\;(x\leqq1)$

(3) $y=\dfrac{a}{x-b}\;(a\neq0)$

$x=\dfrac{a}{y-b} \Rightarrow y-b=\dfrac{a}{x}$

$\therefore y=\dfrac{a}{x}+b$

(4) $y=\dfrac{x-3}{x+2}$

$x=\dfrac{y-3}{y+2}$ とおくと $x(y+2)=y-3 \Rightarrow y(x-1)=-2x-3$
\[
y=\dfrac{-2x-3}{x-1}=\dfrac{2x+3}{1-x}
\]
...
\kotae{
$x$ と $y$ を入れ替えて $x=(y-2)^{2}+3\;(y\geqq2)$．

$(y-2)^{2}=x-3$，$y\geqq2$ より $y-2=\sqrt{x-3}$
