...
\problemrange{4章：指数関数と対数関数 — Basic (p.49-50) 対数（問225--239）}
...
\mondai{229}{$\log_{8}2$ の値を求めよ．}
\kotae{
底 $8$ と真数 $2$ を，ともに $2$ の累乗で表す．

求める値を $x$ とおくと，対数の定義 $\log_{a}M=x \Leftrightarrow a^{x}=M$ より

$8^{x}=2$

$8=2^{3}$ だから

$(2^{3})^{x}=2^{1} \Rightarrow 2^{3x}=2^{1} \Rightarrow 3x=1$

$\therefore \log_{8}2=\dfrac{1}{3}$
}
...
(1) $\log_{2}0.9$，$\log_{2}3\sqrt{2}$，$\log_{2}4$

底 $2>1$ なので，真数の大小がそのまま対数の大小になる．

$3\sqrt{2}=\sqrt{3^{2}\cdot2}=\sqrt{18}$，$4=\sqrt{16}$ であり，$16<18$ だから $4<3\sqrt{2}$

よって真数の大小は $0.9<4<3\sqrt{2}$

$\therefore \log_{2}0.9<\log_{2}4<\log_{2}3\sqrt{2}$
