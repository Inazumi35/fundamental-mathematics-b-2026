...
\kotae{
$0.1=10^{-1}$ だから $10^{-n}\geqq2^{-100}$

両辺の常用対数をとる：$-n\geqq-100\log_{10}2=-30.10$
...
両辺の常用対数をとる：$n\log_{10}0.97\leqq\log_{10}0.5$

$\log_{10}0.97=\log_{10}\dfrac{9.7}{10}=0.9868-1=-0.0132$

$\log_{10}0.5=\log_{10}\dfrac{1}{2}=-\log_{10}2=-0.3010$

$\log_{10}0.97<0$ なので，両辺をこれで割ると不等号の向きが変わる：

$n\geqq\dfrac{-0.3010}{-0.0132}=\dfrac{0.3010}{0.0132}\approx22.8$
