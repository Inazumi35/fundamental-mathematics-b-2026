...
\kotae{
$30°$，$45°$，$60°$ の三角比の値をそのまま代入して計算する．

(1) $\sin60°\cos30°-\cos60°\sin30°$

$=\dfrac{\sqrt{3}}{2}\cdot\dfrac{\sqrt{3}}{2}-\dfrac{1}{2}\cdot\dfrac{1}{2}=\dfrac{3}{4}-\dfrac{1}{4}=\dfrac{1}{2}$

(2) $\cos30°\cos60°+\sin30°\sin60°$

$=\dfrac{\sqrt{3}}{2}\cdot\dfrac{1}{2}+\dfrac{1}{2}\cdot\dfrac{\sqrt{3}}{2}=\dfrac{\sqrt{3}}{4}+\dfrac{\sqrt{3}}{4}=\dfrac{\sqrt{3}}{2}$

(3) $\dfrac{\tan60°-\tan45°}{1+\tan60°\tan45°}=\dfrac{\sqrt{3}-1}{1+\sqrt{3}\cdot1}=\dfrac{\sqrt{3}-1}{\sqrt{3}+1}$

分母を有理化して

$=\dfrac{(\sqrt{3}-1)^{2}}{(\sqrt{3}+1)(\sqrt{3}-1)}=\dfrac{4-2\sqrt{3}}{2}=2-\sqrt{3}$
}
...
\kotae{
鈍角の三角比の値をそのまま代入して計算する．

(1) $\sin45°\cos135°-\cos45°\sin135°$

$=\dfrac{\sqrt{2}}{2}\cdot\left(-\dfrac{\sqrt{2}}{2}\right)-\dfrac{\sqrt{2}}{2}\cdot\dfrac{\sqrt{2}}{2}=-\dfrac{1}{2}-\dfrac{1}{2}=-1$

(2) $\tan45°=1$，$\tan150°=-\dfrac{1}{\sqrt{3}}$ より

$\dfrac{\tan45°-\tan150°}{1+\tan45°\tan150°}=\dfrac{1+\frac{1}{\sqrt{3}}}{1-\frac{1}{\sqrt{3}}}=\dfrac{\sqrt{3}+1}{\sqrt{3}-1}$
