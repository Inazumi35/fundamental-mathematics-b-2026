...
\kotae{
二等辺三角形の外角を利用して，$15°$ をつくる．

$\triangle$ABD は $BA=BD$ の二等辺三角形だから，底角は等しく

$\angle BAD=\angle BDA$

$\angle DBC$ は $\triangle$ABD の頂点 B における外角なので，
隣り合わない2つの内角の和に等しい．

$\angle DBC=\angle BAD+\angle BDA=2\,\angle BAD$

$\angle DBC=30°$ より $\angle BAD=15°$

次に長さを求める．直角三角形 DBC で $\angle C=90°$，$\angle DBC=30°$ だから，
$BD=2$ とすると

$DC=BD\sin30°=1$，$BC=BD\cos30°=\sqrt{3}$

$AB=BD=2$ より $AC=AB+BC=2+\sqrt{3}$

直角三角形 ADC において $\angle DAC=15°$ だから

$\tan15°=\dfrac{DC}{AC}=\dfrac{1}{2+\sqrt{3}}=\dfrac{2-\sqrt{3}}{(2+\sqrt{3})(2-\sqrt{3})}=\dfrac{2-\sqrt{3}}{1}=2-\sqrt{3}$
}
